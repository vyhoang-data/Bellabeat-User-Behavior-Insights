...
* **Incidental movement:** Hourly peaks (~600 steps) are well below a 30-minute walking benchmark (≈3,000–4,000 steps), indicating light or incidental movement rather than dedicated workouts.
